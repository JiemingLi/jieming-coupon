...
public interface IRedisService {
    ...
    void updateCacheTemplate(Long userId,List<Coupon> coupons,Integer status)throws CouponException;

    void addCouponFromExpiredToUsable(Long userId,List<Coupon> coupons) throws CouponException;
